...
// ★ FIXED: Use named import for Algolia v5
import { liteClient as algoliasearch } from "algoliasearch/lite"; 

// 1. Initialize Client (v5 style)
...
export default function HomePage() {
  ...
  const performSearch = useCallback(async () => {
    ...
    try {
      ...
      const KLCC_COORDS = "3.1579, 101.7116";
        ...
        requests: [
          {
            ...
            // Logic: If no query, prioritize radius around KLCC. If query exists, widen radius.
            aroundLatLng: !searchQuery.trim() ? KLCC_COORDS : undefined,
            aroundRadius: !searchQuery.trim() ? "all" : 20000, 
          },
        ],
      });

      // v5 returns 'results' array. We take the first one.
      if (response.results && response.results[0]) {
        // @ts-ignore - Algolia types can be tricky, casting safely here
