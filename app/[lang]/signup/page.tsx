...
import { auth, googleProvider, db } from '../../../lib/firebase'; // Ensure this path matches your project structure

// --- Configuration ---
const AGENT_REGISTER_URL = "https://bm-agent.vercel.app/login"; 
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden font-sans">
      ...
      <div className="relative z-20 w-full max-w-md mx-4">
        <div className="bg-white/20 backdrop-blur-xl border border-white/30 shadow-2xl rounded-3xl p-8 md:p-10 text-white overflow-hidden relative group">
          ...
          <div className="relative z-10">
            <div className="text-center mb-6">
                <h1 className="text-3xl font-black tracking-tight mb-2 text-white drop-shadow-md">Create Account</h1>
                <p className="text-white/80 text-sm font-medium">Join us to find your dream room</p>
            </div>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
                ...
                {/* Name Input */}
                <div>
                    <label className="text-xs font-bold uppercase tracking-wider text-white/70 ml-1 mb-1 block">Full Name</label>
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="w-full bg-black/20 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-white/50 transition backdrop-blur-sm"
                ...
                <button 
                    type="submit" 
                    disabled={loading}
                    className="w-full bg-white text-black font-bold py-3.5 rounded-xl hover:bg-white/90 active:scale-[0.98] transition shadow-lg flex items-center justify-center gap-2 mt-2 disabled:opacity-70 disabled:cursor-not-allowed"
                >
        ...
        {/* --- Agent Signup Button (Outside Card) --- */}
        <div className="mt-8 flex justify-center animate-fade-in-up">
            <a 
                href={AGENT_REGISTER_URL}
            ...
            >
                <div className="w-8 h-8 rounded-full bg-purple-500 flex items-center justify-center text-white shadow-inner">
                    <UserCog size={16} />
                </div>
                <div className="text-left">
                    <p className="text-[10px] font-bold text-white/50 uppercase tracking-widest leading-none mb-0.5">Are you an Agent?</p>
                    <p className="text-sm font-bold text-white leading-none group-hover:text-purple-200 transition-colors">Register as Agent &rarr;</p>
                </div>
            </a>
        </div>
