  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-T6R9TMSK"
            height="0"
            width="0"
...
})(window,document,'script','dataLayer','GTM-T6R9TMSK');`}
        </Script>
        {/* Google tag (gtag.js) */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-647TM3TDXQ"
